...
// AST_T *visitor_visit_rel_expression(visitor_T *visitor, AST_T *node);
...
AST_T *visitor_visit(visitor_T *visitor, AST_T *node)
{
    ...
    case AST_COMPOUND:
        ...
        break;
    case AST_DO_WHILE:
        return visitor_visit_do_while(visitor, node);
        break;
    case AST_ASSIGNMENT:
    ...
    case AST_NOOP:
        ...
        //     break;
        // case AST_BOOL_TERM:
        //     return visitor_visit_bool_term(visitor, node);
        //     break;
        // case AST_BOOL_FACTOR:
        //     return visitor_visit_bool_factor(visitor, node);
        //     break;
